  ...
  return <div className="agent-console">
    ...
    <div className="console-layout">
      ...
      <aside className="metadata-panel console-side">
        ...
        <details open><summary>Lorekeeper visual diff</summary>{proposalPreview ? <LorekeeperDiffPreview preview={proposalPreview} snapshots={markdownSnapshots} snapshotPreview={snapshotPreview} onPreviewSnapshot={async (snapshotPath) => { if (!proposalPreview?.proposal?.targetPageId) return; const response = await onPreviewLorekeeperSnapshot({ targetPageId: proposalPreview.proposal.targetPageId, snapshotPath }); setSnapshotPreview(response?.snapshot ?? response); }} /> : <p className="muted">Preview a proposal to see before/after markdown without applying it.</p>}</details>
...
function LorekeeperDiffPreview({ preview, snapshots, snapshotPreview, onPreviewSnapshot }: { preview: any; snapshots: any[]; snapshotPreview: any; onPreviewSnapshot: (snapshotPath: string) => Promise<void> }) {
