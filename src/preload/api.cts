...
const api = {
  ...
  syncVault: (remoteUrl?: string) => ipcRenderer.invoke('vault:sync', remoteUrl) as Promise<{ pulled: boolean; pushed: boolean }>,
  ...
  importHtmlFilePath: (path: string) => ipcRenderer.invoke('artifacts:import-path', path) as Promise<ArtifactBundle>,
  importBundleDirectory: () => ipcRenderer.invoke('artifacts:import-bundle-directory') as Promise<ArtifactBundle | null>,
  importBundleZip: () => ipcRenderer.invoke('artifacts:import-bundle-zip') as Promise<ArtifactBundle | null>,
  ...
  deleteArtifacts: (ids: string[]) => ipcRenderer.invoke('artifacts:delete', ids) as Promise<boolean>,
  listSnapshots: (id: string) => ipcRenderer.invoke('artifacts:snapshots', id) as Promise<ArtifactSnapshot[]>,
  readSnapshot: (id: string, snapshotId: string) => ipcRenderer.invoke('artifacts:read-snapshot', id, snapshotId) as Promise<string>,
  ...
  exportBundleZip: (id: string) => ipcRenderer.invoke('artifacts:export-bundle-zip', id) as Promise<string | null>,
  exportPdf: (id: string) => ipcRenderer.invoke('artifacts:export-pdf', id) as Promise<string | null>,
