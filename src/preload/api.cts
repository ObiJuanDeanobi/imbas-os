...
const api = {
  ...
  conduitRestoreLorekeeperSnapshot: (input: { targetPageId: string; snapshotPath: string; confirm: string }) => ipcRenderer.invoke('conduit:lorekeeper-snapshot:restore', input) as Promise<any>
};
