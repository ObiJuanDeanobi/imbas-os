...
| #7 | Lorekeeper | Proposal-first workflow plus guarded managed-block apply with source citations, Runledger audit, Command Center proposal summary, and Agent Console transcript-to-artifact path exist. | Rich diff/review UI and snapshot-before-apply. |
